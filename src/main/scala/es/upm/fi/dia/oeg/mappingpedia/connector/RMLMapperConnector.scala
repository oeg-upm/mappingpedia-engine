...
/*  def main(args:Array[String]):Unit = {
    ...
    rmlMapperConnector.executeWithMain(mappingURL, outputFilepath)
...
class RMLMapperConnector() {
  ...
  def executeWithMain(mappingURL:String, outputFilepath:String) = {
    val args: Array[String] = Array("-m", mappingURL, "-o", outputFilepath);
    be.ugent.mmlab.rml.main.Main.main(args);
  }
    ...
    def execute(mappingURL:String, outputFilepath:String) = {
    val args:Array[String] = Array("-m", mappingURL, "-o", outputFilepath);
    //be.ugent.mmlab.rml.main.Main.main(args);
